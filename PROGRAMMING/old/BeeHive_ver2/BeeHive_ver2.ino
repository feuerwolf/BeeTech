...
void setup()
{
    ...
    Serial.println("temp1C, temp2C, weight, sound,");
...
void loop()
{
  ...
  float sound_float  = 0.0;
  
  sensor1.requestTemperatures(); // Send the command to get temperatures
  temp1C_float = getTemperature_sensor1(insideThermometer1); // Use a simple function to print out the data
  sensor2.requestTemperatures(); // Send the command to get temperatures
  temp2C_float = getTemperature_sensor2(insideThermometer2); // Use a simple function to print out the data
